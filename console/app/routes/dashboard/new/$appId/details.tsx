...
const DetailsStep = (props: DetailsStepProp) => {
  ...
  return (
    <div className="flex flex-col gap-1 w-full text-gray-500">
      ...
      <label>
        <span className="font-bold">Name your Application<sup>*</sup></span>
...
export default function AppDetailsPage() {
  ...
  return (
    <WizardFlow>
      <WizardStep label="Application Details" status={WizardStepStatus.Current} appId={appId} action="." next={next}>
        <DetailsStep />
      </WizardStep>
