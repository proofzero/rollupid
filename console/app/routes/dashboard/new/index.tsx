...
const StartButton = (props: StartButtonProps) => {
  return (
    <Form method="post" action=".">
      ...
      <button type="submit" className="grow-0 rounded bg-indigo-500 px-4 py-2 text-white hover:bg-indigo-500 focus:bg-indigo-400">
        Start
      </button>
    </Form>
  );
...
export default function NewAppPage() {
  ...
  return (
    <div>
      ...
      <WizardFlow>
        <WizardStep label="Application Details" status={WizardStepStatus.Unfinished} />
