    ...
    <body class="adaptive">
        <div class="container adaptive">
            <div class="content adaptive">
                ...
                <div style="width: 100%">
                    <a class="footer-links" href="${termsURL}" target="_blank" rel="noreferrer">Terms & Conditions</a>
                    <div class="vl"></div>
                    <a class="footer-links" href="${privacyURL}" target="_blank" rel="noreferrer">Privacy Policy</a>
                    ${
                      contactURL && contactURL !== ''
                        ? `<div class="vl"></div><a class="footer-links" href="${contactURL}" target="_blank"
                ...
                <div style="display: inline-block; text-align: center">
                    <img src="https://imagedelivery.net/VqQy1abBMHYDZwVsTbsSMw/71edc886-0478-4584-beca-a6715937f000/public"
                        alt="" style="max-width: 11px; display: inline-block" />
                    <p style="
                      font-size: 12px;
                      line-height: 12px;
                      color: #9ca3af;
                    ...
                    ">
                        Powered by
                        <a href="https://rollup.id" target="_blank" rel="noreferrer" class="powered-by">rollup.id</a>
                    </p>
                </div>
            </div>
        </div>
