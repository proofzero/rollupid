...
export const EMAIL_VERIFICATION_OPTIONS = {
  ...
  maxAttempts: 5,
  delayBetweenRegenAttemptsInMs: 30_000, //0.5min * 60s * 1000ms
  regenCooldownPeriodInMs: 600_000, //10min * 60s * 1000ms
  maxAttemptsTimePeriodInMs: 300_000, //5 calls within 5 minutes (5min * 60s * 1000ms)
}
