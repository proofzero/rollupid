...
export type AddressProfilesUnion =
...
export type GetProfileQuery = {
  ...
  profile?: {
    ...
    pfp?:
      ...
      | { __typename?: 'StandardPFP'; image?: string | null }
      | null
  } | null
  links?: Array<{
    __typename?: 'Link'
...
export type GetAuthorizedAppsQuery = {
  __typename?: 'Query'
...
export type GetConnectedAddressesQuery = {
  __typename?: 'Query'
  connectedAddresses?: Array<{
    __typename?: 'Node'
    baseUrn: string
...
export type GetAddressProfileQuery = {
  __typename?: 'Query'
  addressProfile: {
    __typename?: 'AddressProfile'
    type: string
...
export type UpdateAddressNicknameMutation = {
  __typename?: 'Mutation'
  updateAddressNickname?: boolean | null
}

export type UpdateConnectedAddressesPropertiesMutationVariables = Exact<{
  addressURNList:
    | Array<ConnectedAddressPropertiesUpdateInput>
    | ConnectedAddressPropertiesUpdateInput
}>
...
export type GetEnsProfileQuery = {
  __typename?: 'Query'
  ensProfile: {
    __typename?: 'CryptoAddressProfile'
    address: string
...
export type GetNftsForAddressQueryVariables = Exact<{
  owner: Scalars['String']
  contractAddresses?: InputMaybe<
    Array<InputMaybe<Scalars['String']>> | InputMaybe<Scalars['String']>
  >
}>

export type GetNftsForAddressQuery = {
  __typename?: 'Query'
  nftsForAddress?: {
    __typename?: 'NFTs'
    ownedNfts: Array<{
      ...
      error?: string | null
      contract?: { __typename?: 'Contract'; address?: string | null } | null
      id?: { __typename?: 'Id'; tokenId?: string | null } | null
      media: Array<{
        __typename?: 'NFTMedia'
        raw?: string | null
...
export type GetNftsPerCollectionQueryVariables = Exact<{
  owner: Scalars['String']
  excludeFilters?: InputMaybe<
    Array<InputMaybe<Scalars['String']>> | InputMaybe<Scalars['String']>
  >
  pageSize?: InputMaybe<Scalars['Int']>
}>

export type GetNftsPerCollectionQuery = {
  __typename?: 'Query'
  contractsForAddress?: {
    __typename?: 'NFTContracts'
    contracts: Array<{
      ...
      numDistinctTokensOwned?: number | null
      name?: string | null
      symbol?: string | null
...
export type GetNftMetadataQueryVariables = Exact<{
  input?: InputMaybe<
    Array<InputMaybe<NftMetadataInput>> | InputMaybe<NftMetadataInput>
  >
}>

export type GetNftMetadataQuery = {
  __typename?: 'Query'
  getNFTMetadataBatch?: {
    __typename?: 'NFTs'
    ownedNfts: Array<{
...
export function getSdk(
  ...
  return {
    ...
    getProfileFromAddress(
      variables: GetProfileFromAddressQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetProfileFromAddressQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetProfileFromAddressQuery>(
            GetProfileFromAddressDocument,
            variables,
    ...
    getAuthorizedApps(
      variables?: GetAuthorizedAppsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetAuthorizedAppsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAuthorizedAppsQuery>(
            GetAuthorizedAppsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getAuthorizedApps',
    ...
    getConnectedAddresses(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetConnectedAddressesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetConnectedAddressesQuery>(
            GetConnectedAddressesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getConnectedAddresses',
    ...
    updateLinks(
      variables?: UpdateLinksMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateLinksMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateLinksMutation>(UpdateLinksDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'updateLinks',
    ...
    updateGallery(
      variables?: UpdateGalleryMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateGalleryMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateGalleryMutation>(
    ...
    getAddressProfile(
      variables: GetAddressProfileQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetAddressProfileQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAddressProfileQuery>(
            GetAddressProfileDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getAddressProfile',
    ...
    getAddressProfiles(
      variables?: GetAddressProfilesQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetAddressProfilesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAddressProfilesQuery>(
            GetAddressProfilesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getAddressProfiles',
    ...
    updateAddressNickname(
      variables: UpdateAddressNicknameMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateAddressNicknameMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateAddressNicknameMutation>(
            UpdateAddressNicknameDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updateAddressNickname',
    ...
    updateConnectedAddressesProperties(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateConnectedAddressesPropertiesMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateConnectedAddressesPropertiesMutation>(
            UpdateConnectedAddressesPropertiesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updateConnectedAddressesProperties',
    ...
    getEnsProfile(
      variables: GetEnsProfileQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetEnsProfileQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetEnsProfileQuery>(GetEnsProfileDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getEnsProfile',
    ...
    getNftsForAddress(
      variables: GetNftsForAddressQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetNftsForAddressQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetNftsForAddressQuery>(
            GetNftsForAddressDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getNftsForAddress',
    ...
    getNftsPerCollection(
      variables: GetNftsPerCollectionQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetNftsPerCollectionQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetNftsPerCollectionQuery>(
            GetNftsPerCollectionDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getNftsPerCollection',
    ...
    getNFTMetadata(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetNftMetadataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetNftMetadataQuery>(
            GetNftMetadataDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getNFTMetadata',
