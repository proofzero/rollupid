...
export const typeToColorsDict = {
  ...
  'primary-alt':
    'bg-indigo-500 text-white shadow-sm hover:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-indigo-500',
  secondary:
  ...
  'secondary-alt':
    'bg-white text-[#1f2937] shadow-sm border border-solid border-[#d1d5db] hover:bg-gray-100 focus:bg-white focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-indigo-500 dark:bg-[#374151] dark:border-gray-600',
  dangerous:
