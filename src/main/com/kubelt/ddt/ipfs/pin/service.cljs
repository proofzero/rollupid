(ns com.kubelt.ddt.ipfs.pin.service
  "CLI setup for 'ipfs pin service' sub-command."
  {:copyright "©2022 Kubelt, Inc." :license "UNLICENSED"}
  (:require
   [com.kubelt.ddt.ipfs.pin.service.add :as service.add]
   [com.kubelt.ddt.ipfs.pin.service.ls :as service.ls]
   [com.kubelt.ddt.ipfs.pin.service.rm :as service.rm]))
