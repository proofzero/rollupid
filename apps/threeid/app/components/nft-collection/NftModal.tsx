...
const NftModal = ({
  ...
  return (
    <Modal isOpen={isOpen} handleClose={handleClose}>
      <div
        className={`flex-1 relative h-[80vh] w-[66vw]
         transform rounded-lg  bg-white px-4 pt-5 pb-4 
         text-left shadow-xl transition-all sm:p-6 overflow-y-auto`}
      >
        <div className="flex flex-row justify-between lg:flex-row max-w-full">
          ...
          <div className="p-0 lg:p-4 w-[100vw] h-[60vh] max-w-full lg:max-w-md mt-3">
            ...
            >
              ...
              <div
                ...
                className={`accordion-collapse border-0 collapse flex flex-row max-w-md  overflow-hidden ${noDetails}`}
                aria-labelledby="flush-headingOne"
              >
                <div className="accordion-body w-[100vw]">
                  {nft?.details?.length ? (
                    ...
                    <div className="accordion-body items-center justify-center text-center">
                      No details
                    </div>
                  )}
                </div>
            ...
            >
              ...
              <div
                ...
                className={`accordion-collapse border-0 collapse show flex flex-row max-w-md  overflow-hidden ${noProps}`}
