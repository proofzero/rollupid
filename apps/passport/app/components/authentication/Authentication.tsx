...
export function Authentication({
  ...
  return (
    <div
      className={
        'flex shrink flex-col items-center justify-center gap-4 mx-auto bg-white p-6 h-[100dvh] lg:h-[598px] lg:max-h-[100dvh] w-full lg:w-[418px] lg:border-rounded-lg'
      }
      style={{
