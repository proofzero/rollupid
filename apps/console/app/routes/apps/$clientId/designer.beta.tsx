...
import { getEmailIcon, modifyType } from '@proofzero/utils/getNormalisedConnectedAccounts'
                ...
                <Tab.Panel>
                  <Authorization
                    ...
                    connectedAccounts={[
                      {
                        title: 'email@example.com',
                        subtitle: `${modifyType(EmailAddressType.Email as string)} - email@example.com`,
                        value: 'urn:rollupid:address/0x98f8b8473269c7e4444756d5ecef7dce5457a5d58df4100b46478402f59de57c',
                      },
                      {
                        title: 'MS Email',
                        subtitle: `${modifyType(OAuthAddressType.Microsoft as string)} - email2@example.com`,
                        value: 'urn:rollupid:address/0x3c7d7e3fef81c03333ed63d4ac83d2a1840356122163985deb1615e6ecfc25be',
                      },
                      {
                        title: 'Github',
                        subtitle: `${modifyType(OAuthAddressType.GitHub as string)} - Github-Account`,
                        value: 'urn:rollupid:address/0xa69240d7b361e122d22aa68ff97b9530c7c85953fba9dac392ca8dbfb88e17cc',
                      },
                      {
                        title: 'ens.eth',
                        subtitle: `${modifyType(CryptoAddressType.ETH as string)} - 0x6c60Da9471181Aa54C648c6e203663A5501363F3`,
